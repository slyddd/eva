/*
  All this component is a modification of the @dapi-labs library
  called react-nice-avatar,
  specifically the port to React Native created by @zamplyy.
  All the credits to the original authors.

  zamplyy's version is available at:
    - https://github.com/zamplyy/react-native-nice-avatar
